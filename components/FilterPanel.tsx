                ...
                <div className="space-y-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <Input
                                    ...
                                    onChange={(e) => handleFilterChange('bloomSize', {
                                        ...filters.bloomSize,
                                        min: e.target.value
                                    })}
                                />
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <Input
                                    ...
                                    onChange={(e) => handleFilterChange('scapeHeight', {
                                        ...filters.scapeHeight,
                                        min: e.target.value
                                    })}
                                />
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <Input
                                    ...
                                    onChange={(e) => handleFilterChange('branches', {
                                        ...filters.branches,
                                        min: e.target.value
                                    })}
                                />
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="grid grid-cols-2 gap-2">
                                <Input
                                    ...
                                    onChange={(e) => handleFilterChange('budCount', {
                                        ...filters.budCount,
                                        min: e.target.value
                                    })}
                                />
                    ...
                    <div className="space-y-2">
                        ...
                        <RadioGroup
                            ...
                            onValueChange={(value) => handleFilterChange('ploidy', value)}
                        >
                    ...
                    <div className="space-y-2">
                        ...
                        <RadioGroup
                            ...
                            onValueChange={(value) => handleFilterChange('foliageType', value)}
                        >
                            <div className="space-y-2">
